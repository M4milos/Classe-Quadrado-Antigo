...
class Quadrado{
    ...
    private $idTabuleiro;
        ...
        public function Salvar(){
            ...
            $salvar->bindValue(':lado', $this->getLado());
            $salvar->bindValue(':cor', $this->getCor());
            $salvar->bindValue(':idTabuleiro', $this->getIdtab());
        ...
        public function Editar(){
            ...
            $editar->bindValue(':cor', $this->getCor(), PDO::PARAM_STR); 
            $editar->bindValue(':id', $this->getId(), PDO::PARAM_STR);
            $editar->bindValue(':idTabuleiro', $this->getIdtab());
